...
$width = 585
$height = 559
$output = Join-Path $PSScriptRoot "..\assets\templates\polymons-shirt-template.png"
...
$inkBrush = [System.Drawing.SolidBrush]::new(
  [System.Drawing.ColorTranslator]::FromHtml($colors.Ink)
)
$noteBrush = [System.Drawing.SolidBrush]::new(
  [System.Drawing.ColorTranslator]::FromHtml($colors.Note)
)
...
$graphics.DrawString("CLASSIC SHIRT TEMPLATE", $noteFont, $noteBrush, 18, 43)
...
$graphics.DrawString("Paint colored faces.", $noteFont, $noteBrush, 18, 120)
$graphics.DrawString("Keep art inside edges.", $noteFont, $noteBrush, 18, 140)
$graphics.DrawString("TORSO", $sectionFont, $inkBrush, 380, 20)
$graphics.DrawString("F = front | B = back", $noteFont, $noteBrush, 377, 220)
$graphics.DrawString("L/R = side faces", $noteFont, $noteBrush, 377, 238)
$graphics.DrawString("UP/DOWN fold on top/bottom.", $noteFont, $noteBrush, 377, 256)
$graphics.DrawString("Dashed line = arm middle.", $noteFont, $noteBrush, 377, 274)
$graphics.DrawString("RIGHT ARM", $sectionFont, $inkBrush, 18, 526)
$graphics.DrawString("LEFT ARM", $sectionFont, $inkBrush, 390, 526)
